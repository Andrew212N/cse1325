...
*    Date: 11/14/2022
*    Code version: 1.0
*    Availability: https://github.com/prof-rice/cse1325-prof/tree/main/P07/gui
*
***************************************************************************************/
...
public class MainWin extends JFrame {
    ...
    public MainWin() {
       ...
       // Add a New Emporium icon
        ...
        saveAsButton  = new JButton(new ImageIcon("gui/saveas.png"));
        ...
        createScoopButton  = new JButton(new ImageIcon("gui/newscoop.png"));
        ...
        JButton viewScoopsButton  = new JButton(new ImageIcon("gui/viewscoop.png"));
   ...
   protected void onOpenClick() { 
        ...
        if (result == JFileChooser.APPROVE_OPTION) { // Also CANCEL_OPTION and ERROR_OPTION
            ...
            try (BufferedReader br = new BufferedReader(new FileReader(filename))) {
                ...
                emporium = new Emporium();                   // Open a new emporium
